...
Chunk Chunk::deserialize_from_stream(std::istream &in, std::string *error) {
  Chunk chunk;
...
Chunk Chunk::deserialize(const std::string &path, std::string *error) {
  ...
  return deserialize_from_stream(in, error);
}

Chunk Chunk::deserialize_from_bytes(const unsigned char *data,
                                      std::size_t length,
                                      std::string *error) {
